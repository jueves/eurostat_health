...
'''
Para la versión 2 habría que añadir una sección de descarga y descompresión
de los archivos.

La función principal podría tomar por argumentos "staff", "deaths"...
o también la url del archivo.
'''

#file_name = 'data/estand_deaths_per_region.tsv'
file_name = 'data/staff by region.tsv'
#def import_eurostat_dataset(file_name):
'''
...
#   
# deaths_raw_file = 'data/estand_deaths_per_region.tsv'
# deaths_new_file = 'data/estand_deaths_per_region.csv'
# deaths_metadata_file = 'data/meta_estand_deaths_per_region.csv'
# 
# 
# deaths_data, deaths_metadata = import_eurostat_dataset(deaths_raw_file)
# deaths_data.to_csv(deaths_new_file)
# deaths_metadata.to_csv(deaths_metadata_file)
